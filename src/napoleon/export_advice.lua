...
--[[ 8000_Campaign_Advice_Britain_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("spa_britain", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8000_Campaign_Advice_Britain_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end
...
events.BattleUnitAttacksEnemyUnit[#events.BattleUnitAttacksEnemyUnit+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattleUnitIsPlayers(context) and conditions.BattlePlayerUnitCategory("artillery", context) and conditions.BattleEnemyUnitCategory("cavalry", context) and not conditions.BattlePlayerUnitActionStatus("fighting_melee", context) and (conditions.BattleEnemyUnitActionStatus("moving_fast", context) or conditions.BattleEnemyUnitActionStatus("charging", context)) then
...
events.BattleConflictPhaseCommenced[#events.BattleConflictPhaseCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattleTimeLimitSet(context) then
...
events.BattleUnitAttacksEnemyUnit[#events.BattleUnitAttacksEnemyUnit+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattleUnitIsPlayers(context) and conditions.BattlePlayerUnitCategory("cavalry", context) and not conditions.BattlePlayerUnitClass("cavalry_missile", context) and not conditions.BattlePlayerUnitClass("elephants", context) and not conditions.BattlePlayerUnitClass("dragoons", context) and conditions.BattlePlayerUnitMovingFast(context) then
...
--[[ 0106_Battle_Advice_Land_Killometer_Trigger ]]--
...
function (context)
	if conditions.BattleIsNavalConflict(context) and conditions.BattlePlayerShipActionStatus("sinking", context) then
...
events.BattleShipAttacksEnemyShip[#events.BattleShipAttacksEnemyShip+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) and conditions.BattlePlayerShipActionStatus("dismasted", context) then
...
events.BattleShipAttacksEnemyShip[#events.BattleShipAttacksEnemyShip+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) and conditions.BattleShipSailsPercentageDamage(context) == 100 then
...
events.BattleShipAttacksEnemyShip[#events.BattleShipAttacksEnemyShip+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) and conditions.BattlePlayerShipActionStatus("hull_damaged", context) then
...
events.BattleShipMagazineExplosion[#events.BattleShipMagazineExplosion+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) and not conditions.BattleShipIsPlayers(context) and not conditions.BattleUnitIsAllied(context) then
...
function (context)
	if conditions.BattleIsNavalConflict(context) and conditions.BattlePlayerShipActionStatus("routing", context) then
...
events.BattleShipAttacksEnemyShip[#events.BattleShipAttacksEnemyShip+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) and conditions.BattleEnemyShipActionStatus("pursue_routers", context) and conditions.BattlePlayerShipActionStatus("routing", context) then
...
events.BattleShipRouts[#events.BattleShipRouts+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) and conditions.BattleEnemyShipActionStatus("routing", context) then
...
events.BattleShipAttacksEnemyShip[#events.BattleShipAttacksEnemyShip+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) and not conditions.BattleShipIsPlayers(context) and conditions.BattleEnemyShipActionStatus("wavering", context) and conditions.BattleAllianceNumberOfUnits(context) >= 2 then
...
--[[ 0221_Battle_Advice_Keeping_Control_Trigger ]]--

events.BattleFortPlazaCaptureCommenced[#events.BattleFortPlazaCaptureCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) then
...
--[[ 0300_Battle_Advice_Extreme_Weather_Trigger ]]--

events.BattleConflictPhaseCommenced[#events.BattleConflictPhaseCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) then
		effect.advance_contextual_advice_thread("0300_Battle_Advice_Extreme_Weather_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0301_Battle_Advice_Radar_Map_Trigger ]]--

events.BattleDeploymentPhaseCommenced[#events.BattleDeploymentPhaseCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) then
		effect.advance_contextual_advice_thread("0301_Battle_Advice_Radar_Map_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0302_Battle_Advice_Generals_Influence_Trigger ]]--

events.BattleConflictPhaseCommenced[#events.BattleConflictPhaseCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattleAllianceIsPlayers(context) and conditions.BattleCommanderIsGeneral(context) then
		effect.advance_contextual_advice_thread("0302_Battle_Advice_Generals_Influence_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0303_Battle_Advice_Rally_Button_Pressed_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.IsComponentType("", context) then
		effect.advance_contextual_advice_thread("0303_Battle_Advice_Rally_Button_Pressed_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0304_Battle_Advice_Repair_Button_Trigger ]]--

events.BattleConflictPhaseCommenced[#events.BattleConflictPhaseCommenced+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) then
		effect.advance_contextual_advice_thread("0304_Battle_Advice_Repair_Button_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0305_Battle_Advice_Boarding_Meter_Trigger ]]--

events.BattleBoardingActionCommenced[#events.BattleBoardingActionCommenced+1] =
function (context)
	if conditions.BattleIsNavalConflict(context) then
		effect.advance_contextual_advice_thread("0305_Battle_Advice_Boarding_Meter_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0306_Battle_Advice_Deployment_Order_Trigger ]]--

events.BattleDeploymentPhaseCommenced[#events.BattleDeploymentPhaseCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) then
		effect.advance_contextual_advice_thread("0306_Battle_Advice_Deployment_Order_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0307_Battle_Advice_Generals_Inspiration_Trigger ]]--

events.BattleConflictPhaseCommenced[#events.BattleConflictPhaseCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattleCommanderIsGeneral(context) and conditions.BattlePlayerAlliancePercentageOfSpecialAbility("inspire_unit", context) >= 1 then
		effect.advance_contextual_advice_thread("0307_Battle_Advice_Generals_Inspiration_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0308_Battle_Advice_Inspire_Button_Pressed_Trigger ]]--

events.BattleUnitRouts[#events.BattleUnitRouts+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattleUnitIsPlayers(context) then
		effect.advance_contextual_advice_thread("0308_Battle_Advice_Inspire_Button_Pressed_Thread", 1, context)
		return true
	end
	return false
end

--[[ 0309_Battle_Advice_Rallying_Trigger ]]--

events.BattleUnitAttacksEnemyUnit[#events.BattleUnitAttacksEnemyUnit+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattleUnitIsPlayers(context) and conditions.BattlePlayerUnitActionStatus("wavering", context) then
		effect.advance_contextual_advice_thread("0309_Battle_Advice_Rallying_Thread", 1, context)
		return true
	end
	return false
end
...
--[[ 1001a_Campaign_Advice_Britain_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.CampaignName("mp_eur_napoleon", context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("britain", context) then
		effect.advance_contextual_advice_thread("1001a_Campaign_Advice_Britain_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end
...
--[[ 1002a_Campaign_Advice_France_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.CampaignName("ita_napoleon", context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("ita_french_republic", context) then
		effect.advance_contextual_advice_thread("1002a_Campaign_Advice_France_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end

--[[ 1002b_Campaign_Advice_France_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.CampaignName("egy_napoleon", context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("egy_french_republic", context) then
		effect.advance_contextual_advice_thread("1002b_Campaign_Advice_France_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end

--[[ 1002c_Campaign_Advice_France_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.CampaignName("eur_napoleon", context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("france", context) then
		effect.advance_contextual_advice_thread("1002c_Campaign_Advice_France_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end
...
--[[ 1005a_Campaign_Advice_Russia_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.CampaignName("mp_eur_napoleon", context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("russia", context) then
		effect.advance_contextual_advice_thread("1005a_Campaign_Advice_Russia_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end
...
--[[ 1006a_Campaign_Advice_Prussia_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.CampaignName("mp_eur_napoleon", context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("prussia", context) then
		effect.advance_contextual_advice_thread("1006a_Campaign_Advice_Prussia_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end
...
--[[ 1009a_Campaign_Advice_Austria_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.CampaignName("mp_eur_napoleon", context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("austria", context) then
		effect.advance_contextual_advice_thread("1009a_Campaign_Advice_Austria_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end
...
--[[ 1014k_Campaign_Advice_UI_Diplomacy_Panel_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.IsComponentType("", context) then
		effect.advance_contextual_advice_thread("1014k_Campaign_Advice_UI_Diplomacy_Panel_Thread", 1, context)
		return true
	end
	return false
end
...
events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("diplomacy_button_break_trade", context) then
...
events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("diplomacy_button_request_join_war", context) then
...
events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("diplomacy_button_break_alliance", context) then
...
events.PanelOpenedCampaign[#events.PanelOpenedCampaign+1] =
function (context)
	if conditions.IsComponentType("technology", context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
...
events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("tab_military", context) and not conditions.CampaignName("ita_napoleon", context) then
...
events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("tab_taxes", context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 7 and not conditions.CampaignName("spa_napoleon", context) then
...
events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("agents_tab", context) and not conditions.CampaignName("spa_napoleon", context) then
...
function (context)
	if conditions.CharacterIsLocalCampaign(context) and (conditions.CharacterType("General", context) or conditions.CharacterType("colonel", context)) and not conditions.CampaignName("spa_napoleon", context) then
...
events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterType("gentleman", context) and not conditions.CharacterFactionName("spa_spain", context) then
...
--[[ 1082b_Campaign_Advice_Right_Click_Details_Trigger ]]--
...
function (context)
	if conditions.RegionIsLocal(context) and conditions.IsHomeRegion(context) and conditions.TurnNumber(context) == 9 and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
...
function (context)
	if conditions.IsPlayerTurn(context) and conditions.FactionIsLocal(context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.FactionGovernmentType("gov_absolute_monarchy", context) and conditions.TurnNumber(context) == 14 and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.FactionGovernmentType("gov_constitutional_monarchy", context) and conditions.TurnNumber(context) == 14 and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.FactionGovernmentType("gov_republic", context) and conditions.TurnNumber(context) == 14 and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and (conditions.FactionGovernmentType("gov_constitutional_monarchy", context) or conditions.FactionGovernmentType("gov_republic", context)) and conditions.TurnNumber(context) == 15 and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
...
function (context)
	if conditions.SlotIsLocal(context) and conditions.SlotBuildingQueueIdleDespiteCash(context) and (conditions.SlotType("sheep", context) or conditions.SlotType("wheat", context) or conditions.SlotType("rice", context) or conditions.SlotType("corn", context) or conditions.SlotType("cattle", context)) and (conditions.TurnsSinceThreadLastAdvanced("1103_Campaign_Advice_Undeveloped_Farm_Thread", context) == 0 or conditions.TurnsSinceThreadLastAdvanced("1103_Campaign_Advice_Undeveloped_Farm_Thread", context) == 5) and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 16 then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 8 and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 10 and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 12 and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) >= 18 then
...
function (context)
	if conditions.RegionIsLocal(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.RegionTurnStart[#events.RegionTurnStart+1] =
function (context)
	if conditions.RegionIsLocal(context) and conditions.RegionClamoursReform(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.SupportCostsPercentage(context) > 60 and conditions.FactionTreasury(context) > 0 and (conditions.FactionTaxLevel("upper_classes", context) < conditions.TaxLevel("tax_extortionate", context) or conditions.FactionTaxLevel("lower_classes", context) < conditions.TaxLevel("tax_extortionate", context)) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.FactionTreasury(context) <= 0 and conditions.UnusedInternationalTradeRoute(context) and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("ita_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.FactionTreasury(context) <= 0 and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("ita_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.SupportCostsPercentage(context) > 60 and conditions.FactionTreasury(context) <= 0 and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.FactionTreasury(context) < 200 and (conditions.FactionTaxLevel("upper_classes", context) < conditions.TaxLevel("tax_extortionate", context) or conditions.FactionTaxLevel("lower_classes", context) < conditions.TaxLevel("tax_extortionate", context)) and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("ita_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.FactionTreasury(context) < 200 and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("ita_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.UnusedInternationalTradeRoute(context) and (conditions.TurnsSinceThreadLastAdvanced("1127_Campaign_Advice_Warning_Trade_Thread", context) == 0 or conditions.TurnsSinceThreadLastAdvanced("1127_Campaign_Advice_Warning_Trade_Thread", context) == 5) and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
...
events.RegionTurnStart[#events.RegionTurnStart+1] =
function (context)
	if conditions.RegionIsLocal(context) and not conditions.IsHomeRegion(context) and conditions.AdjacentRegionRebelling(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
		return true
	end
	return false
end
...
events.RegionTurnStart[#events.RegionTurnStart+1] =
function (context)
	if conditions.RegionIsLocal(context) and conditions.IsHomeRegion(context) and conditions.AdjacentRegionRebelling(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
		return true
	end
	return false
end
...
events.RegionTurnStart[#events.RegionTurnStart+1] =
function (context)
	if conditions.RegionIsLocal(context) and conditions.RegionTaxLevel("upper_classes", context) == conditions.TaxLevel("tax_extortionate", context) and not conditions.RegionTaxExempt(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
		return true
	end
	return false
end
...
events.RegionTurnStart[#events.RegionTurnStart+1] =
function (context)
	if conditions.RegionIsLocal(context) and conditions.RegionTaxLevel("lower_classes", context) == conditions.TaxLevel("tax_extortionate", context) and not conditions.RegionTaxExempt(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
		return true
	end
	return false
end
...
events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.RegionIsLocal(context) and not conditions.RegionCultureIsFactionCulture(context) and (conditions.TurnsSinceThreadLastAdvanced("1135_Campaign_Advice_Warning_Culture_Shock_Thread", context) == 0 or conditions.TurnsSinceThreadLastAdvanced("1135_Campaign_Advice_Warning_Culture_Shock_Thread", context) == 5)  and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.RegionTurnStart[#events.RegionTurnStart+1] =
function (context)
	if conditions.RegionIsLocal(context) and conditions.RegionPopulationLow(context) and conditions.RegionTaxLevel("lower_classes", context) >= conditions.TaxLevel("tax_high", context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
		return true
	end
	return false
end
...
function (context)
	if conditions.TradeRouteIsEnemy(context) and conditions.IsPlayerTurn(context) and not conditions.CampaignName("egy_napoleon", context) then
...
function (context)
	if conditions.FactionIsLocal(context) and conditions.SeaTradeRouteRaided(context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionRoundStart[#events.FactionRoundStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LandTradeRouteRaided(context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 11 and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
		return true
	end
	return false
end
...
events.SlotRoundStart[#events.SlotRoundStart+1] =
function (context)
	if not conditions.SlotIsLocal(context) and not conditions.SlotIsAlliedCampaign(context) and not conditions.IsColony(context) and (conditions.SlotType("port", context) and conditions.IsBuildingInChain("port-trade", context)) and conditions.PortBlockadedLocal(context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.SlotRoundStart[#events.SlotRoundStart+1] =
function (context)
	if conditions.SlotIsLocal(context) and not conditions.IsColony(context) and (conditions.SlotType("port", context) and conditions.IsBuildingInChain("port-trade", context)) and conditions.PortBlockaded(context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.SlotRoundStart[#events.SlotRoundStart+1] =
function (context)
	if conditions.SlotIsLocal(context) and conditions.IsColony(context) and (conditions.SlotType("port", context) and conditions.IsBuildingInChain("port-trade", context)) and conditions.PortBlockaded(context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.SlotOccupied[#events.SlotOccupied+1] =
function (context)
	if not conditions.SlotIsLocal(context) and conditions.SlotType("port", context) and conditions.IsPlayerTurn(context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.RegionTurnStart[#events.RegionTurnStart+1] =
function (context)
	if conditions.RegionIsLocal(context) and conditions.RegionEconomicGrowthLow(context) and (conditions.TurnsSinceThreadLastAdvanced("1166_Campaign_Advice_Slow_Economic_Growth_Thread", context) == 0 or conditions.TurnsSinceThreadLastAdvanced("1166_Campaign_Advice_Slow_Economic_Growth_Thread", context) == 5) and not conditions.CampaignName("egy_napoleon", context) and not conditions.CampaignName("ita_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.FactionTreasury(context) <= 0 and conditions.TaxCollectionLimited(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.LosingMoney(context) and conditions.FactionTreasury(context) <= 2000 and conditions.TaxCollectionLimited(context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("egy_napoleon", context) then
...
events.PanelAdviceRequestedCampaign[#events.PanelAdviceRequestedCampaign+1] =
function (context)
	if conditions.IsComponentType("government_screens", context) and not conditions.CampaignName("spa_napoleon", context) then
...
events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("research", context) and not conditions.CampaignName("ita_napoleon", context) and not conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("1019_Campaign_Advice_UI_Technology_Panel_Thread", 1, context)
		return true
	end
	return false
...
events.CharacterTurnStart[#events.CharacterTurnStart+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and (conditions.CharacterType("General", context) or conditions.CharacterType("colonel", context)) and conditions.CharacterStationaryForOneTurn(context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.IsPlayerTurn(context) and conditions.FactionHasTradeShipNotInTradeNode(context) and conditions.TradeNodeAvailableWorldwide(context) and not conditions.CampaignName("egy_napoleon", context) then
...
--[[ 2191_Campaign_Advice_Undeveloped_Roads_Trigger ]]--

events.SlotTurnStart[#events.SlotTurnStart+1] =
function (context)
	if conditions.SlotIsLocal(context) and conditions.SlotBuildingQueueIdleDespiteCash(context) and conditions.SlotType("settlement_road", context) and (conditions.TurnsSinceThreadLastAdvanced("2190_Campaign_Advice_Undeveloped_Roads_Thread", context) == 0 or conditions.TurnsSinceThreadLastAdvanced("2190_Campaign_Advice_Undeveloped_Roads_Thread", context) == 5) then
		effect.advance_contextual_advice_thread("2191_Campaign_Advice_Undeveloped_Roads_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2192_Campaign_Advice_New_Turn_Times_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 3 and not conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("2192_Campaign_Advice_New_Turn_Times_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2193_Campaign_Advice_New_Seasons_Trigger ]]--

events.AdviceDismissed[#events.AdviceDismissed+1] =
function (context)
	if conditions.AdviceJustDisplayed(-1452083206, context) then
		effect.advance_contextual_advice_thread("2193_Campaign_Advice_New_Seasons_Thread", 1, context)
		return true
	end
	return false
end
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 5 and not conditions.CampaignName("spa_napoleon", context) then
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 4 and not conditions.CampaignName("spa_napoleon", context) then
...
--[[ 2196_Campaign_Advice_Poor_Duellist_Advice_Trigger ]]--

events.DuelDemanded[#events.DuelDemanded+1] =
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("orthodox_missionary", context) or conditions.CharacterType("Protestant_Missionary", context)) and conditions.CharacterDuelsFought(context) >= 10 and conditions.CharacterDuelsLost(context) >= 7 then
		effect.advance_contextual_advice_thread("2196_Campaign_Advice_Poor_Duellist_Advice_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2197_Campaign_Advice_Replenishment_Advice_Trigger ]]--

events.CharacterCompletedBattle[#events.CharacterCompletedBattle+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterArmyCouldReplenishFromBattle(context) and (conditions.CharacterType("colonel", context) or conditions.CharacterType("General", context)) then
		effect.advance_contextual_advice_thread("2197_Campaign_Advice_Replenishment_Advice_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2198_Campaign_Advice_Spy_Network_Advice_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterType("rake", context) then
		effect.advance_contextual_advice_thread("2198_Campaign_Advice_Spy_Network_Advice_Thread", 1, context)
		return true
	end
	return false
end
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 6 and not conditions.CampaignName("egy_napoleon", context) then
...
--[[ 2200_Campaign_Advice_UI_Help_Looting_Panel_Trigger ]]--

events.PanelAdviceRequestedCampaign[#events.PanelAdviceRequestedCampaign+1] =
function (context)
	if conditions.IsComponentType("settlement_captured", context) and not conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("2200_Campaign_Advice_UI_Help_Looting_Panel_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2201_Campaign_Advice_Observation_Balloon_Trigger ]]--

events.CharacterTurnStart[#events.CharacterTurnStart+1] =
function (context)
	if conditions.CharacterType("General", context) and (conditions.CharacterFactionName("france", context) or conditions.CharacterFactionName("egy_french_republic", context)) and conditions.CharacterAttribute("command_land", context) >= 6 then
		effect.advance_contextual_advice_thread("0001_Battle_Advice_Friendly_Fire_Thread", 1, context)
		effect.advance_contextual_advice_thread("2201_Campaign_Advice_Observation_Balloon_Thread", 1, context)
		return true
	end
	return false
end
...
events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 2 and not conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("2202_Campaign_Advice_Drop_In_Battles_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2209_Campaign_Advice_Changing_Building_Type_Trigger ]]--

events.ComponentLClickUp[#events.ComponentLClickUp+1] =
function (context)
	if conditions.IsComponentType("construction_tab", context) then
		effect.advance_contextual_advice_thread("2209_Campaign_Advice_Changing_Building_Type_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2210_Campaign_Advice_UI_Help_Recruit_Commanders_Trigger ]]--

events.PanelAdviceRequestedCampaign[#events.PanelAdviceRequestedCampaign+1] =
function (context)
	if conditions.IsComponentType("enlist_commander", context) then
		effect.advance_contextual_advice_thread("2210_Campaign_Advice_UI_Help_Recruit_Cmd_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2210a_Campaign_Advice_Army_Promotions_Trigger ]]--
...
--[[ 2210b_Campaign_Advice_Navy_Promotions_Trigger ]]--
...
--[[ 2212_Campaign_Advice_Liberation_Trigger ]]--

events.CharacterCanLiberate[#events.CharacterCanLiberate+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and not conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("2212_Campaign_Advice_Liberation_Thread", 1, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.IsPlayerTurn(context) and not conditions.CampaignName("spa_napoleon", context) then
...
--[[ 2215_Campaign_Advice_Right_Click_Details_Trigger ]]--

events.PanelAdviceRequestedCampaign[#events.PanelAdviceRequestedCampaign+1] =
function (context)
	if conditions.IsComponentType("CharacterInfoUnitInfoPopup", context) then
		effect.advance_contextual_advice_thread("2215_Campaign_Advice_UI_Help_Characters_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2197a_Campaign_Advice_Replenishment_Advice_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterArmyCouldReplenishFromBattle(context) and conditions.CharacterType("colonel", context) then
		effect.advance_contextual_advice_thread("2197_Campaign_Advice_Replenishment_Advice_Thread", 1, context)
		return true
	end
	return false
...
--[[ 8017_Campaign_Advice_Trade_Supplies_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 2 and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8017_Campaign_Advice_Trade_Supplies_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8008a_Campaign_Advice_Spanish_Guerrillero_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 5 and conditions.FactionName("spa_spain", context) and conditions.CampaignName("spa_napoleon", context) then
		return true
	end
	return false
end

--[[ 8008c_Campaign_Advice_British_Guerrillero_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterFactionName("spa_britain", context) and conditions.CharacterType("guerilla", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8008b_Campaign_Advice_British_Guerrillero_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8018_Campaign_Advice_UI_Help_Government_Trigger ]]--

events.PanelAdviceRequestedCampaign[#events.PanelAdviceRequestedCampaign+1] =
function (context)
	if conditions.IsComponentType("government_screens", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8018_Campaign_Advice_UI_Help_Government_Thread", 1, context)
		return true
	end
	return false
end

--[[ 2203_Campaign_Advice_UI_Help_Drop_In_Battles_Trigger ]]--

events.PanelAdviceRequestedCampaign[#events.PanelAdviceRequestedCampaign+1] =
function (context)
	if conditions.IsComponentType("checkbox_dropin", context) then
		effect.advance_contextual_advice_thread("2203_Campaign_Advice_Drop_In_Battles_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8003a_Campaign_Advice_Recruit_Restrictions_Trigger ]]--

events.SlotSelected[#events.SlotSelected+1] =
function (context)
	if conditions.SlotIsLocal(context) and conditions.IsBuildingInChain("pSupplySpain", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8003_Campaign_Advice_Recruit_Restrictions_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8001_Campaign_Advice_Spain_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("spa_spain", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8001_Campaign_Advice_Spain_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8002_Campaign_Advice_France_Initial_Turns_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 1 and conditions.FactionName("spa_france", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8002_Campaign_Advice_France_Initial_Turns_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8003_Campaign_Advice_Recruit_Restrictions_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 3 and conditions.FactionName("spa_britain", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8003_Campaign_Advice_Recruit_Restrictions_Thread", 1, context)
		return true
	end
	return false
...
--[[ 8004_Campaign_Advice_Anti_French_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 3 and conditions.FactionName("spa_france", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8004_Campaign_Advice_Anti_French_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8005_Campaign_Advice_British_Provocateur_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterType("Protestant_Missionary", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8005_Campaign_Advice_British_Provocateur_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8006_Campaign_Advice_French_Provocateur_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterType("orthodox_missionary", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8006_Campaign_Advice_French_Provocateur_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8007_Campaign_Advice_Spanish_Priest_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterType("catholic_missionary", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8007_Campaign_Advice_Spanish_Priest_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8008_Campaign_Advice_Spanish_Guerrillero_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterFactionName("spa_spain", context) and conditions.CharacterType("guerilla", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8008_Campaign_Advice_Spanish_Guerrillero_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8009_Campaign_Advice_Harassment_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 5 and conditions.FactionName("spa_france", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8009_Campaign_Advice_Harassment_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8010_Campaign_Advice_British_Guerrilla_Unit_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterType("General", context) and conditions.CharacterFactionName("spa_britain", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8010_Campaign_Advice_British_Guerrilla_Unit_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8011_Campaign_Advice_Spanish_Guerrilla_Unit_Trigger ]]--

events.CharacterSelected[#events.CharacterSelected+1] =
function (context)
	if conditions.CharacterIsLocalCampaign(context) and conditions.CharacterType("General", context) and conditions.CharacterFactionName("spa_spain", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8011_Campaign_Advice_Spanish_Guerrilla_Unit_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8012_Battle_Advice_Using_Guerrilla_Units_Trigger ]]--

events.BattleDeploymentPhaseCommenced[#events.BattleDeploymentPhaseCommenced+1] =
function (context)
	if conditions.BattleIsLandConflict(context) and conditions.BattlePlayerAlliancePercentageGuerrillas(context) >= 1 then
		effect.advance_contextual_advice_thread("8012_Battle_Advice_Using_Guerrilla_Units_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8013_Campaign_Advice_Missions_Trigger ]]--

events.MissionIssued[#events.MissionIssued+1] =
function (context)
	if not conditions.TurnNumber(context) == 2 and not conditions.TurnNumber(context) == 3 and not conditions.TurnNumber(context) == 4 and not conditions.TurnNumber(context) == 5 then
		effect.advance_contextual_advice_thread("8013_Campaign_Advice_Missions_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8014_Campaign_Advice_Political_Alignment_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 4 and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8014_Campaign_Advice_Political_Alignment_Thread", 1, context)
		return true
	end
	return false
end

--[[ 8008b_Campaign_Advice_British_Guerrillero_Trigger ]]--

events.FactionTurnStart[#events.FactionTurnStart+1] =
function (context)
	if conditions.FactionIsLocal(context) and conditions.TurnNumber(context) == 5 and conditions.FactionName("spa_britain", context) and conditions.CampaignName("spa_napoleon", context) then
		effect.advance_contextual_advice_thread("8008b_Campaign_Advice_British_Guerrillero_Thread", 1, context)
		return true
	end
	return false
