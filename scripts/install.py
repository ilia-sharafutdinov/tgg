...
# print('Making sounds_sfx backup.')
# if not os.path.isfile(os.path.join(install_dir, 'data', 'sounds_sfx.pack.bak')):
#     shutil.move(os.path.join(install_dir, 'data', 'sounds_sfx.pack'), os.path.join(install_dir, 'data', 'sounds_sfx.pack.bak'))

print('Copying compiled.')
shutil.copytree(compiled_dir, install_dir, dirs_exist_ok=True, ignore=shutil.ignore_patterns('patch6.pack'))

print('Copying lib.')
shutil.copytree(lib_dir, install_dir, dirs_exist_ok=True, ignore=shutil.ignore_patterns('sounds_sfx.pack', 'README.md'))
